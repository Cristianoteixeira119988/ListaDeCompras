...
public class CriaListaBricolage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cria_lista_bricolage);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        botaoguardar = (Button) findViewById(R.id.buttonGuardar2);
        TextEditNomelista= (EditText) findViewById(R.id.EditTextNomeDalista2);
        botaocancelar = (Button) findViewById(R.id.buttonCancelar2);
        textviewdata = (TextView) findViewById(R.id.textViewData2);
        ...
        botaoguardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mensagem.trim().length() == 0){
                    ...
                    Toast.makeText(CriaListaBricolage.this, getString(R.string.lista_criada), Toast.LENGTH_SHORT).show();
                    Intent paguinainicial = new Intent(CriaListaBricolage.this, AdicionarProduto.class);
        ...
        botaocancelar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent paguinainicial = new Intent(CriaListaBricolage.this, MainActivity.class);
                startActivity(paguinainicial);
